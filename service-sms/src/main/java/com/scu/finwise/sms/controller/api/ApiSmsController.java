package com.scu.finwise.sms.controller.api;
...
import com.scu.finwise.common.util.RandomUtils;
import com.scu.finwise.common.util.RegexValidateUtils;
import com.scu.finwise.sms.service.SmsService;
...
public class ApiSmsController {
    ...
    public R send(
        ...
        //将验证码存入redis
        redisTemplate.opsForValue().set("finwise:sms:code:" + mobile, code, 5, TimeUnit.MINUTES);
