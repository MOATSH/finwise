...
import com.scu.finwise.common.exception.BusinessException;
...
import com.scu.finwise.core.service.DictService;
...
public class AdminDictController {
    ...
    public R batchImport(
        ...
        try {
            ...
            return R.ok().changeMessage("批量导入成功");
        } catch (Exception e) {
